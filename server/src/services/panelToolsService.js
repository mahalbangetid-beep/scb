    ...
    async createServiceForwardRule(userId, panelId, data) {
        return prisma.serviceForwardRule.create({
            data: {
                ...
                forwardSpeedup: data.forwardSpeedup !== undefined ? data.forwardSpeedup : true,
                forwardStatus: data.forwardStatus !== undefined ? data.forwardStatus : false,
    ...
    async updateServiceForwardRule(id, userId, data) {
        ...
        return prisma.serviceForwardRule.update({
            ...
            data: {
                ...
                forwardSpeedup: data.forwardSpeedup !== undefined ? data.forwardSpeedup : existing.forwardSpeedup,
                forwardStatus: data.forwardStatus !== undefined ? data.forwardStatus : existing.forwardStatus,
                deviceId: data.deviceId !== undefined ? (data.deviceId || null) : existing.deviceId,
